...
public interface Factory {
    ...
    Operation createOperation(int id, String type, int bankAccountId, double amount, String description, Category categoryId);
    Operation createOperation(int bankAccountId, double amount, String description, Category categoryId);
